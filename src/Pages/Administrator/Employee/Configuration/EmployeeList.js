...
import { AddEmployee, DeleteEmployee, GetEmployee } from "../../../../Repository/EmployeeRepository";
import { ModalDelete } from "../../../../Components/Modals";
import { GetEmployeeStatus, GetJobGrade, GetJobLevel, GetJobPosition, GetJobTittle } from "../../../../Repository/AdminRepository";
...
function EmployeeList() {
  ...
  return (
    <>
      ...
      {/* Modal Add */}
      <Modal show={modalAdd} size="lg" onHide={() => { setModalAdd(false); setController({}); setProfilePict(null); }}>
        <Modal.Header
          closeButton
          className="mx-4 mt-4"
        ...
        <Modal.Body className="mx-4">
          <div>
            <label htmlFor="imagePicker"><img src={profilePict ?? profile} className="rounded-full w-20 h-20" style={{ objectFit: "fill", }}></img></label>
            <input type="file" id="imagePicker" multiple={false} hidden onChange={(val) => {
              var url = URL.createObjectURL(val.currentTarget.files[0]);
              setProfilePict(url);
              setController({ ...controller, image: val.currentTarget.files[0] });
            }} />
          </div>
          <div className="grid grid-cols-2 gap-3 mt-3">
            <div className="w-full">
              ...
              <input
                onChange={(val) => { setController({ ...controller, firstName: val.target.value }) }}
            ...
            <div className="w-full">
              ...
              <input
                onChange={(val) => { setController({ ...controller, joinDate: val.target.value }) }}
            ...
            <div className="w-full">
              ...
              <select onChange={(val) => setController({ ...controller, employeestatus_id: val.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div className="w-full">
              ...
              <select onChange={(val) => setController({ ...controller, jobgrade_id: val.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option hidden>--Select--</option>
                {
                  jobGrade.map((e, i) => {
                    return (
            ...
            <div className="w-full">
              ...
              <select onChange={(val) => setController({ ...controller, joblevel_id: val.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option hidden>--Select--</option>
                {
                  jobLevel.map((e, i) => {
                    return (
            ...
            <div className="w-full">
              ...
              <select onChange={(val) => setController({ ...controller, jobtitle_id: val.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option hidden>--Select--</option>
                {
                  jobTitle.map((e, i) => {
                    return (
            ...
            <div className="w-full">
              ...
              <select onChange={(val) => setController({ ...controller, jobposition_id: val.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option hidden>--Select--</option>
                {
                  jobPosition.map((e, i) => {
                    return (
            ...
            <div className="w-full">
              ...
              <input
                onChange={(val) => setController({ ...controller, location: val.target.value })}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                type="text"
          ...
          <div className="mt-3">
            ...
            >
              <input
                ...
                onClick={() => { setShow((prev) => !prev); setController({ ...controller, username: "", password: "", confirm: "", status: null, }); }}
              />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={(val) => setController({ ...controller, username: val.target.value })}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    type="text"
                    placeholder=""
                  />
              ...
              <div className="grid grid-cols-2 gap-3 mt-3">
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={(val) => setController({ ...controller, password: val.target.value })}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    type="text"
                    placeholder=""
                  />
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={(val) => setController({ ...controller, confirm: val.target.value })}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    type="text"
                    placeholder=""
                  />
                ...
                <div className="flex flex-row gap-5">
                  <div className="flex items-center mb-4">
                    <input
                      ...
                      type="radio"
                      value={true}
                      onChange={(val) => setController({ ...controller, status: val.target.value })}
                      name="default-radio"
        ...
        <Modal.Footer className="m-4">
          <button
            onClick={() => { setModalAdd(false); setController({}); setProfilePict(null); }}
            type="button"
      ...
      {/* Modal Update */}
      <Modal show={modalUpdate} size="lg" onHide={() => { setModalUpdate(false); setController({}); setProfilePict(null); }}>
        <Modal.Header
          closeButton
          className="mx-4 mt-4"
          style={{ borderBottomColor: "transparent" }}
        ...
        <Modal.Footer className="m-4">
          <button
            onClick={() => { setModalUpdate(false); setController({}); setProfilePict(null); }}
            type="button"
            className="text-[#003049] bg-gray-200 hover:bg-gray-300 font-sm rounded-lg text-sm px-4 py-2.5 mr-2 mb-2 dark:bg-gray-200 dark:hover:bg-gray-300 focus:outline-none"
          >
            Cancel
