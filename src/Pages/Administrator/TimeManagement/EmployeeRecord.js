...
import { Add, AlignVerticalCenter, ArrowLeft, ArrowRight, ArrowUpwardTwoTone, Delete, DeleteOutline, EditOutlined, Filter, Filter1, FilterCenterFocus, FilterList, ImportExport, Search, Visibility, VisibilityOutlined } from "@mui/icons-material";
    ...
    return (
        <>
            <div className="w-100 bg-light p-4 rounded-t-xl">
                <h5><b>Employee Record</b></h5>
                <p><small>list of record employee attendance</small></p>
                <br></br>
                <div className="d-flex justify-content-between">
                    <div>
                        <input type="date" className="bg-light-50 border border-gray-300 text-[#00000030] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                    <div className="d-flex">
                        ...
                        <Button onClick={() => {
                            setUser(!dialogUser);
                        }} style={{ color: "#FFFFFF", borderRadius: "7px", backgroundColor: "#0E5073", }} variant="contained" startIcon={<Add />}>Manual Check In / Out</Button>
                    </div>
                </div>
                <br></br>
                <Table borderless responsive style={{ color: "#00000070" }}>
                    <thead>
                        <tr style={{ backgroundColor: "#EBF7FF" }}>
                            ...
                            <th onClick={() => { }} style={{ minWidth: "20em", }}>Employee Name <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Date <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }} style={{ minWidth: "10em", }}>Check In <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }} style={{ minWidth: "20em", }}>Check In Note <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }} style={{ minWidth: "10em", }}>Check Out <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }} style={{ minWidth: "20em", }}>Check Out Note <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }} style={{ minWidth: "10em", }}>Duration <ImportExport fontSize="2px" /></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="align-middle">
                                <button onClick={() => setDetailUser(!dialogDetailUser)} className="btn btn-sm mx-1" style={{ backgroundColor: "#CEDFEA", borderRadius: "8px", }}><VisibilityOutlined fontSize="10px" /></button>
                            </td>
                        </tr>
                    </tbody>
                </Table>
            ...
            <div className="bg-[#FBFBFB] mt-0 px-4 py-3 rounded-b-xl d-flex align-items-center justify-content-between ">
                <div>
                    <h6 className="text-[#A098AE]">Showing <span className="text-[#0E5073]">1-5</span> from <span className="text-[#0E5073]">100</span> data</h6>
                </div>
                <div>
                    <button className="btn btn-sm"><ArrowLeft /></button>
                    <button className="btn mx-2 bg-[#78000010] rounded-md text-[#780000]">1</button>
                    <button className="btn bg-[#780000] rounded-md text-[#FFFFFF]">2</button>
                    <button className="btn mx-2 bg-[#78000010] rounded-md text-[#780000]">3</button>
                    <button className="btn btn-sm"><ArrowRight /></button>
                </div>
            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12 mb-3">
                            <div className="form-group">
                                ...
                                <input className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="time" placeholder="Select Time" />
                            </div>
                        </div>
                        <div className="col-md-12 mb-3">
                            <div className="form-group">
                                <label className="mb-1">Employee Name <span className="text-danger">*</span></label>
                                <textarea rows={4} placeholder="Note check in / out here" className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <Modal show={dialogDetailUser} size="lg" onHide={() => setDetailUser(!dialogDetailUser)}>
                <Modal.Header
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-5">
                                    ...
                                    <div className="mt-2 px-2 py-4 text-center rounded-xl bg-[#EDEDED]">
                                        <center><Camera size={50} className="text-[#00000050]" /></center>
