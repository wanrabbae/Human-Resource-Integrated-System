    ...
    return (
        <>
            <div className="w-100 p-4" style={{ backgroundColor: "#FFFFFF", borderRadius: "10px" }}>
                <h5><b>License</b></h5>
                <p><small>list of License</small></p>
                <br></br>
                <div className="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        }} style={{ color: "#FFFFFF", borderRadius: "7px", backgroundColor: "#0E5073", }} variant="contained" startIcon={<Add />}>Add License</Button>
                    </div>
                </div>
                <br></br>
                <Table borderless responsive style={{ color: "#00000070" }}>
                    <thead>
                        <tr style={{ backgroundColor: "#EBF7FF" }}>
                            ...
                            <th onClick={() => { }}>License <ImportExport fontSize="2px" /></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="align-middle" style={{ minWidth: "200px", }}>Cisco Certified Network Professional (CCNP)</td>
                    ...
                    <div className="row">
                        <div className="col-md-12 mb-3">
                            <div className="form-group">
                                <label className="mb-1">License Name <span className="text-danger">*</span></label>
                                <input className="bg-light-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="License name..." />
                            </div>
                        </div>
                        <div className="col-md-12 mb-3">
                            <div className="form-group">
                                <label className="mb-1">Attachment <span className="text-danger">*</span></label>
                                <TextFieldFile />
                            </div>
                        </div>
                    </div>
