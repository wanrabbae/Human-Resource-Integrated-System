...
function DetailApplicant() {
    return (
        ...
        <div className="d-flex align-items-center mb-5 justify-content-between">
                <div className="row">
                    <h3 style={{ fontSize: "20px", fontWeight: '600' }}>Detail  Applicant</h3>
                </div>
                <div className="d-flex">
                    <button style={{ color:'white', backgroundColor: "#0E5073", fontSize: "14px", fontWeight: '500' }} className="ms-3 btn d-flex align-items-center" onClick={() => { }} type=""><Export  className="me-2" size={15} weight="bold" />Export</button>
                </div>
            </div>
        <div className="mb-5 bg-[#F8F8F8] rounded-xl px-4 py-5" style={{color:'#737373'}}>
                        ...
                        <div className='d-flex gap-x-6 gap-y-1' style={{fontSize:'14px'}}>    
                            <div className='col-6' style={{fontSize:'14px'}}>
                                <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                                    ...
                                    <div style={{fontWeight:'500'}}>: Jl Patimura timur gg. Melati No.2, Kecamatan Ambal, Kabupaten Kebument, Jawa Tengah , Indonesia </div>
                    ...
                    <div className="mb-2 bg-[#F8F8F8] rounded-xl px-4 py-5" style={{color:'#737373'}}>
