...
import { AddEmployeeStatus, GetEmployeeStatus } from "../../../../Repository/AdminRepository";
            ...
            <div className="w-100 p-4" style={{ backgroundColor: "#FFFFFF", borderRadius: "10px" }}>
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        }} style={{ color: "#FFFFFF", borderRadius: "7px", backgroundColor: "#0E5073", }} variant="contained" startIcon={<Add />}>Add Employee Status</Button>
                    </div>
                </div>
                <br></br>
                <Table borderless responsive style={{ color: "#00000070" }}>
                    <thead>
                        <tr style={{ backgroundColor: "#EBF7FF" }}>
                            ...
                            <th onClick={() => { }}>Employee Status <ImportExport fontSize="2px" /></th>
                    ...
                    <div className="row">
                        <div className="col-md-12 mb-3">
                            <div className="form-group">
                                <label className="mb-1">Employee Status <span className="text-danger">*</span></label>
                                <input className="form-control" id="name" placeholder="Employee Status..." />
                            </div>
                        </div>
                    </div>
                ...
                <Modal.Body className="mx-4">
                    <div className="row">
                        <div className="col-md-12 mb-3">
                            <div className="form-group">
                                <label className="mb-1">Employee Status <span className="text-danger">*</span></label>
                                <input className="form-control" placeholder="Employee Status..." />
                            </div>
                        </div>
                    </div>
                </Modal.Body>
