    ...
    return (
        <>
            <div className="w-100 p-4" style={{ backgroundColor: "#FFFFFF", borderRadius: "10px" }}>
                <h5><b>Company Locations</b></h5>
                <p><small>list of Company Locations</small></p>
                <br></br>
                <div className="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        }} style={{ color: "#FFFFFF", borderRadius: "7px", backgroundColor: "#0E5073", }} variant="contained" startIcon={<Add />}>Add Location</Button>
                    </div>
                </div>
                <br></br>
                <Table borderless responsive style={{ color: "#00000070" }}>
                    <thead>
                        <tr style={{ backgroundColor: "#EBF7FF" }}>
                            ...
                            <th onClick={() => { }}>Name <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>City <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Country <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Phone <ImportExport fontSize="2px" /></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="align-middle" style={{ minWidth: "200px", }}>Ethos Karya</td>
                            <td className="align-middle" style={{ minWidth: "200px", }}>Cilacap</td>
                            <td className="align-middle" style={{ minWidth: "200px", }}>Indonesia</td>
                            <td className="align-middle" style={{ minWidth: "200px", }}>081238429231</td>
            ...
            <Modal show={dialogTitle} size="lg" onHide={() => setTitle(!dialogTitle)}>
                ...
                <Modal.Body className="mx-4">
                    <div className="row">
                        ...
                        <div className="col-md-6 my-3">
                            <div className="form-group">
                                <label className="mb-1">Postal Code <span className="text-danger">*</span></label>
                                <input placeholder="Postal Code..." type="number" className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 my-3">
                            <div className="form-group">
                                ...
                                <input placeholder="Phone number..." type="number" className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                        </div>

                        <div className="col-md-6 my-3">
                            <div className="form-group">
                                <label className="mb-1">Fax <span className="text-danger">*</span></label>
                                <input placeholder="Fax number..." type="number" className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                        </div>
                        ...
                        <div className="col-md-12 my-3">
                            <div className="form-group">
                                ...
                                <textarea rows={4} className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Address..."></textarea>
                            </div>
                        </div>
                        <div className="col-md-12 my-3">
                            <div className="form-group">
