    ...
    return (
        <>
            <div className="w-100 bg-[#FFFFFF] p-4 rounded-t-xl">
                <h5><b>Schedule</b></h5>
                <p><small>list of Schedule</small></p>
                <br></br>
                <div className="d-flex justify-content-between">
                    ...
                    <div className="d-flex">
                        ...
                        <Button onClick={() => {
                            setUser(!dialogUser);
                        }} style={{ color: "#FFFFFF", borderRadius: "7px", backgroundColor: "#0E5073", }} variant="contained" startIcon={<Add />}>Schedule</Button>
                    </div>
                </div>
                <br></br>
                <Table borderless responsive style={{ color: "#00000070" }}>
                    <thead>
                        <tr style={{ backgroundColor: "#EBF7FF" }}>
                            ...
                            <th onClick={() => { }}>Current Schedule <ImportExport fontSize="2px" /></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                ...
                <Modal.Body className="mx-4">
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            <div className="form-group">
                                <label className="mb-1">Schedule <span className="text-danger">*</span></label>
                                <select className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div className="col-md-6 mb-3">
                            <div className="form-group">
                                <label className="mb-1">Effective Date <span className="text-danger">*</span></label>
                                <input type="date" className="bg-light-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                        </div>
                    </div>
