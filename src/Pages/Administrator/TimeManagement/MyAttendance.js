...
import { Add, AlignVerticalCenter, ArrowBack, ArrowLeft, ArrowRight, ArrowUpwardTwoTone, Delete, DeleteOutline, EditOutlined, Filter, Filter1, FilterCenterFocus, FilterList, ImportExport, Search, Visibility, VisibilityOutlined } from "@mui/icons-material";
    ...
    return (
        <>
            <div className="w-100 bg-[#FFFFFF] p-4 rounded-t-xl">
                ...
                <p><small>list of attendance</small></p>
                <br></br>
                <div className="d-flex justify-content-between">
                    ...
                    <div className="d-flex">
                        ...
                        <Button onClick={() => {
                            setUser(!dialogUser);
                        }} style={{ color: "#FFFFFF", borderRadius: "7px", backgroundColor: "#0E5073", }} variant="contained" startIcon={<Add />}>Check In/Out</Button>
                    </div>
                </div>
                <br></br>
                <Table borderless responsive style={{ color: "#00000070" }}>
                    <thead>
                        <tr style={{ backgroundColor: "#EBF7FF" }}>
                            ...
                            <th onClick={() => { }}>Check In <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Check In Note <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Check Out <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Check Out Note <ImportExport fontSize="2px" /></th>
                            <th onClick={() => { }}>Duration <ImportExport fontSize="2px" /></th>
