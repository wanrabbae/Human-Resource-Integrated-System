    ...
    <div>
      ...
      <div className="bg-[#ECEEF6] p-5 mt-5 space-y-5">
        ...
        <div className="flex flex-col md:flex-row gap-3 justify-center">
          <div className="bg-white w-full md:w-1/4 h-screen rounded-lg overflow-hidden shadow-md border">
          ...
          <div className="bg-[#CADAE8] w-full md:w-1/4 h-screen rounded-lg overflow-hidden shadow-md border">
            <div className="px-6 py-4 space-y-5">
