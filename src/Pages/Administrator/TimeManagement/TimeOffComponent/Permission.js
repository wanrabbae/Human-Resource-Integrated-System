    ...
    <div className="bg-white p-5 rounded-lg">
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr>
              ...
              <td className="py-4 px-6">Izin Keluar Kantor</td>
            ...
            <tr>
              <td className="py-4 px-6">Veza Adi</td>
              <td className="py-4 px-6">Staff IT</td>
              <td className="py-4 px-6">Izin Terlambat Masuk</td>
              <td className="py-4 px-6">
                <div className="flex flex-col items-center gap-1">
            ...
            <tr>
              <td className="py-4 px-6">Veza Adi</td>
              <td className="py-4 px-6">Staff IT</td>
              <td className="py-4 px-6">Izin Sakit</td>
              <td className="py-4 px-6">
                <div className="flex flex-col items-center gap-1">
      ...
      <Modal open={modalEdit} onClose={() => setModalEdit(false)}>
        ...
        >
          <div className="m-5">
            <div className="flex justify-between mb-5">
              <h3 className="font-semibold text-xl">Edit Permission</h3>
